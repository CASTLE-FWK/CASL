...
class Printers {
	...
	static def String copyrightPrint(String fname) {
		...
		val SimpleDateFormat dateFormat = new SimpleDateFormat("HH:mm:ss 'on' yyyy/MM/dd");
		val Date date = new Date();
		val String timeStamp = dateFormat.format(date);
...
//				println("IM A FEATURE")
	...
	static def printExpression(Expression expr, String name) {
		if (expr instanceof MacroCall) {
			return MacroGenerator.parseMacro((expr as MacroCall), name)
		} else {
