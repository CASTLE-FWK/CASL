 ...
 * </p>
 * <ul>
 *   <li>{@link uofa.lbirdsey.castle.casl.impl.TypeRefImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypeRefImpl extends ExpressionImpl implements TypeRef
{
  ...
  {
    return CaslPackage.eINSTANCE.getTypeRef();
  }
    ...
    if (type != null && type.eIsProxy())
    {
      ...
      if (type != oldType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, CaslPackage.TYPE_REF__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(Symbol newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CaslPackage.TYPE_REF__TYPE, oldType, type));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CaslPackage.TYPE_REF__TYPE:
