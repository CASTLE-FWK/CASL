 ...
 * </p>
 * <ul>
 *   <li>{@link uofa.lbirdsey.castle.casl.impl.InteractionImpl#getName <em>Name</em>}</li>
 *   <li>{@link uofa.lbirdsey.castle.casl.impl.InteractionImpl#getInteraction_type <em>Interaction type</em>}</li>
 *   <li>{@link uofa.lbirdsey.castle.casl.impl.InteractionImpl#getTrigger_type <em>Trigger type</em>}</li>
 *   <li>{@link uofa.lbirdsey.castle.casl.impl.InteractionImpl#getTriggerParam <em>Trigger Param</em>}</li>
 *   <li>{@link uofa.lbirdsey.castle.casl.impl.InteractionImpl#getFunctionParameters <em>Function Parameters</em>}</li>
 *   <li>{@link uofa.lbirdsey.castle.casl.impl.InteractionImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InteractionImpl extends Entity_FeatureImpl implements Interaction
{
  /**
  ...
  {
    return CaslPackage.eINSTANCE.getInteraction();
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CaslPackage.INTERACTION__NAME, oldName, name));
  }
  ...
  public void setInteraction_type(InteractionType newInteraction_type)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CaslPackage.INTERACTION__INTERACTION_TYPE, oldInteraction_type, interaction_type));
  }
  ...
  public void setTrigger_type(InteractionTriggerTypes newTrigger_type)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CaslPackage.INTERACTION__TRIGGER_TYPE, oldTrigger_type, trigger_type));
  }
  ...
  public NotificationChain basicSetTriggerParam(InteractionTriggerParameter newTriggerParam, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CaslPackage.INTERACTION__TRIGGER_PARAM, oldTriggerParam, newTriggerParam);
  ...
  public void setTriggerParam(InteractionTriggerParameter newTriggerParam)
  {
    if (newTriggerParam != triggerParam)
    {
      ...
      if (triggerParam != null)
        msgs = ((InternalEObject)triggerParam).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CaslPackage.INTERACTION__TRIGGER_PARAM, null, msgs);
      if (newTriggerParam != null)
        msgs = ((InternalEObject)newTriggerParam).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CaslPackage.INTERACTION__TRIGGER_PARAM, null, msgs);
      msgs = basicSetTriggerParam(newTriggerParam, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CaslPackage.INTERACTION__TRIGGER_PARAM, newTriggerParam, newTriggerParam));
  }
  ...
  public EList<Symbol> getFunctionParameters()
  {
    ...
    {
      functionParameters = new EObjectContainmentEList<Symbol>(Symbol.class, this, CaslPackage.INTERACTION__FUNCTION_PARAMETERS);
    }
  ...
  public EList<EObject> getBody()
  {
    if (body == null)
    {
      body = new EObjectContainmentEList<EObject>(EObject.class, this, CaslPackage.INTERACTION__BODY);
    }
    return body;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CaslPackage.INTERACTION__TRIGGER_PARAM:
        return basicSetTriggerParam(null, msgs);
      case CaslPackage.INTERACTION__FUNCTION_PARAMETERS:
        return ((InternalEList<?>)getFunctionParameters()).basicRemove(otherEnd, msgs);
      case CaslPackage.INTERACTION__BODY:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CaslPackage.INTERACTION__NAME:
        return getName();
      case CaslPackage.INTERACTION__INTERACTION_TYPE:
        return getInteraction_type();
      case CaslPackage.INTERACTION__TRIGGER_TYPE:
