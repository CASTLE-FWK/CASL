...
public class CaslAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected CaslSwitch<Adapter> modelSwitch =
    new CaslSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseCASL_Macro_InitLogger(CASL_Macro_InitLogger object)
      {
        return createCASL_Macro_InitLoggerAdapter();
      }
      @Override
      ...
      @Override
      public Adapter caseCASL_Macro_NEW(CASL_Macro_NEW object)
      {
        return createCASL_Macro_NEWAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link uofa.lbirdsey.castle.casl.CASL_Macro_InitLogger <em>CASL Macro Init Logger</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createCASL_Macro_InitLoggerAdapter()
  {
    return null;
  }
  ...
  /**
   * Creates a new adapter for an object of class '{@link uofa.lbirdsey.castle.casl.CASL_Macro_GET_ID <em>CASL Macro GET ID</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link uofa.lbirdsey.castle.casl.CASL_Macro_NEW <em>CASL Macro NEW</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createCASL_Macro_NEWAdapter()
  {
    return null;
  }
